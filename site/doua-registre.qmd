...
Trei cazuri concrete unde diferă sentiment-ul aceleiași entități **în aceeași perioadă** (apples-to-apples):

| Entitate | Perioadă | Pe Facebook | În video |
|---|---|---|---|
| **Trump** | Q1 2026 | Pozitiv | **Mixt** (rezerve) |
| **PSD** | Q2 2025 (campanie) | **Negativ** explicit | Mixt (temperat) |
| **Simion** | Q2 2025 (campanie) | n/a (doar hashtag-uri) | **Negativ** explicit |

::: {.callout-note}
## Detaliu importat despre PSD
PSD apare pe FB **doar în campanie** (Q2 2025) — atunci e NEGATIV. După campanie ND **nu mai postează despre PSD pe FB**, chiar dacă devin parteneri de coaliție.

Pe video însă, PSD apare continuu: NEUTRU la formarea guvernului (Q3 2025) → MIXT în coaliție (Q4 2025 – Q1 2026) → **NEGATIV** din nou când relația se tensionează (Q2 2026, criza Pfizer).

ND alege **selectiv** când să atace pe FB.
:::
