...
results = {
    "Metoda": [
        "Burrows' Delta — distanță centroidă scris↔vorbit",
        "Burrows' Delta — accuracy nearest-centroid",
        "Random Forest — 5-fold cross-validation accuracy",
        "Random Forest — held-out 30% test",
    ],
    "Rezultat": [
        "0.297",
        "78.1%",
        "92.1% ± 1.7%",
        "94.9% (116/118 FB + 89/98 video corecte)",
    ],
    "Interpretare": [
        "Distanță moderată — cele 2 register-uri sunt distincte stilometric",
        "Vs ~50% random — semnal clar de discriminare",
        "Model simplu distinge FB de video cu acuratețe foarte mare",
        "Doar 2 FB confundate cu video; 9 video confundate cu FB",
    ],
}
df = pd.DataFrame(results)
print(df.to_html(index=False, escape=False, classes="table"))
```
