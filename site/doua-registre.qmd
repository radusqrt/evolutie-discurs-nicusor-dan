...
Cuvinte care fac diferența cel mai mult:

**Folosite preponderent în video (oral spontan)**:

| Cuvânt | De câte ori mai des în video | Tip |
|---|---|---|
| `niște` | **259×** | indefinit colocvial |
| `o` (numeral) | 56× | filler scurt |
| `ăă` | **41×** | filler ezitare |
| `într` | 28× | conector oral |
| `deci` | **26×** | conector argumentativ oral |
| `ă` | 22× | filler ezitare |
| `crede` | 14× | verb modal personal |
| `spune` | 6,8× | verb relatare |
| `acesta` | 4,9× | deictic ("asta") |
| `că` | 3× | conjuncție orală |

**Folosite preponderent pe Facebook (scris formal)**:

| Cuvânt | De câte ori mai des pe FB | Tip |
|---|---|---|
| `prin` | 3,7× | prepoziție formală |
| `al` | 2,6× | articol posesiv formal |
| `și` | 1,6× | conjuncție |
| `pentru` | 1,5× | prepoziție |
